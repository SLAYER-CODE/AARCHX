...
echo ""
echo "# Socket name (default: MANDELA_SOCKET env o 'mandela-overlay'):"
echo "  /data/local/aarchdroid/root/iris --socket=mi-socket"
echo "  MANDELA_SOCKET=mi-socket /data/local/aarchdroid/root/iris"
echo ""
echo "# Verbose:"
echo "  /data/local/aarchdroid/root/iris --verbose"
echo ""
echo "Nota: MANDELA_TERMINAL=1 y MANDELA_SOCKET=mandela-overlay"
