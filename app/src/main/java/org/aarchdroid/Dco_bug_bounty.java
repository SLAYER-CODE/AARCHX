    ...
    protected void onCreate(Bundle bundle) {
        try {
            ...
            createAdapter(list, loadToolsFromDb(), new ToolAdapter.OnToolClickListener() {
                ...
                @Override
                public void onUninstallClick(String toolKey) { Dco_bug_bounty.this.onUninstallClick(toolKey); }
                @Override
                public void onLaunchTool(String toolKey) { Dco_bug_bounty.this.onLaunchTool(toolKey); }
            });
