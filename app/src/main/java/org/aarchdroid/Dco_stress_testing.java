    ...
    protected void onCreate(Bundle bundle) {
        try {
            ...
            createAdapter(list, loadToolsFromDb(), new ToolAdapter.OnToolClickListener() {
                ...
                @Override
                public void onUninstallClick(String toolKey) { Dco_stress_testing.this.onUninstallClick(toolKey); }
                @Override
                public void onLaunchTool(String toolKey) { Dco_stress_testing.this.onLaunchTool(toolKey); }
            });
