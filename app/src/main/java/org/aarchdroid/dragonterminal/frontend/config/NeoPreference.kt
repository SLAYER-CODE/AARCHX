...
object NeoPreference {
    ...
    fun store(key: Int, value: Any) {
        store(AArchDroidApp.get().getString(key), value)
    }
    ...
    fun loadInt(key: Int, defaultValue: Int): Int {
        return loadInt(AArchDroidApp.get().getString(key), defaultValue)
    }

    fun loadString(key: Int, defaultValue: String?): String {
        return loadString(AArchDroidApp.get().getString(key), defaultValue)
    }

    fun loadBoolean(key: Int, defaultValue: Boolean): Boolean {
        return loadBoolean(AArchDroidApp.get().getString(key), defaultValue)
    }
    ...
    fun getLoginShellName(): String {
        return loadString(R.string.key_general_shell, AArchDroidApp.get().filesDir.absolutePath+"/bin/"+DefaultValues.loginShell)
    }
    ...
    fun getLoginShellPath(): String {
        ...
        val loginProgramPath = findLoginProgram(loginProgramName) ?: {
            setLoginShellName(AArchDroidApp.get().filesDir.absolutePath+"/bin/"+DefaultValues.loginShell)
            AArchDroidApp.get().filesDir.absolutePath+"/bin/"+DefaultValues.loginShell
        }()
    ...
    fun findLoginProgram(loginProgramName: String): String? {
        val file = File(loginProgramName)
    ...
    fun getInitialCommand(): String {
        ...
        return loadString(R.string.key_general_initial_command, DefaultValues.initialCommand)
    }
    ...
    fun isFullScreenEnabled() : Boolean {
        return loadBoolean(R.string.key_ui_fullscreen, DefaultValues.enableFullScreen)
    }
