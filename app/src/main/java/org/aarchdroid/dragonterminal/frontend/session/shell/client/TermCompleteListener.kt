package org.aarchdroid.dragonterminal.frontend.session.shell.client
...
import org.aarchdroid.dragonterminal.frontend.completion.listener.OnCandidateSelectedListener
import org.aarchdroid.dragonterminal.frontend.completion.model.CompletionCandidate
import org.aarchdroid.dragonterminal.frontend.completion.model.CompletionResult
import org.aarchdroid.dragonterminal.frontend.completion.view.CandidatePopupWindow
...
class TermCompleteListener(var terminalView: TerminalView?) : OnAutoCompleteListener, OnCandidateSelectedListener {
    ...
    override fun onCandidateSelected(candidate: CompletionCandidate) {
        ...
        NLog.e("NeoTerm-AC", "currentEditing: $textNeedCompletion, " +
