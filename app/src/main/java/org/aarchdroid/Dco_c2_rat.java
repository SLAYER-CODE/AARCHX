    ...
    protected void onCreate(Bundle bundle) {
        try {
            ...
            createAdapter(list, loadToolsFromDb(), new ToolAdapter.OnToolClickListener() {
                ...
                @Override
                public void onUninstallClick(String toolKey) { Dco_c2_rat.this.onUninstallClick(toolKey); }
                @Override
                public void onLaunchTool(String toolKey) { Dco_c2_rat.this.onLaunchTool(toolKey); }
            });
