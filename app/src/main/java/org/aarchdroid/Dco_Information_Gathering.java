    ...
    protected void onCreate(Bundle bundle) {
        try {
            ...
            createAdapter(list, loadToolsFromDb(), new ToolAdapter.OnToolClickListener() {
                ...
                @Override
                public void onUninstallClick(String toolKey) { Dco_Information_Gathering.this.onUninstallClick(toolKey); }
                @Override
                public void onLaunchTool(String toolKey) { Dco_Information_Gathering.this.onLaunchTool(toolKey); }
            });
