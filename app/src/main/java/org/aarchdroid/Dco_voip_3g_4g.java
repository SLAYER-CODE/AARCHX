...
public class Dco_voip_3g_4g extends DcoBaseActivity {
        ...
        try {
            ...
            createAdapter(list, buildToolList(), new ToolAdapter.OnToolClickListener() {
                ...
                public void onUninstallClick(String toolKey) {
                    Dco_voip_3g_4g.this.onUninstallClick(toolKey);
                }

                @Override
                public void onLaunchTool(String toolKey) {
                    Dco_voip_3g_4g.this.onLaunchTool(toolKey);
                }
            });
    ...
    private List<ToolItem> buildToolList() {
        ...
        list.add(makeItem("mmeenodebhack", "MME-eNodeB", "MME enhanced with eNodeB", "mme-enodeb", "lte"));
        ...
        list.add(makeItem("diameterenum", "Diameter-Enum", "Diameter Scanner", "diameter-enum -h", "diametertower"));
        list.add(makeItem("s1apenum", "S1AP-Enum", "S1SetupRequest PDU to MME", "s1ap-enum", "diametertower"));
        list.add(makeItem("gtpscan", "GTP-Scan", "GTP Scanner", "gtp-scan -h", "diametertower"));
